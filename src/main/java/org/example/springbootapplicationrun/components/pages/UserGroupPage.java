...
public class UserGroupPage {
    ...
    public JSONArray getGroups() throws InterruptedException {
        ...
        driver.findElements(By.xpath("//a [@aria-label='View group']")).forEach(groupLink -> {
            ...
            group.setImage(groupLink.findElement(By.xpath("./parent::div/preceding-sibling::div/div/a/div/div/svg/mask/following-sibling::g/image")).getAttribute("xlink:href"));
